    ...
    <Container fluid className="mt-4 px-2 px-md-4" id="recipe-details">
      {currRecipe ? (
        <div>
          <Row className="mb-4">
            ...
            <Col xs={12} md={7} lg={8}>
              <div className="d-flex justify-content-between align-items-start mb-2">
                <h2 className="mb-0 me-2 flex-grow-1" style={{ 
                  lineHeight: "1.2"  
                }}>
                  {currRecipe.name}
                </h2>
              ...
              <div className="d-flex flex-column flex-sm-row justify-content-between align-items-start mb-3">
                <div className="mb-2 mb-sm-0">
                  <div><strong>Total Time:</strong> {currRecipe.total_time}</div>
                  <div><strong>Serves:</strong> {currRecipe.serves}</div>
                </div>
          ...
          {/* Comments Section */}
          <div className="mb-4">
            <h5 className="mb-3">Comments ({currPost?.comments?.length || 0})</h5>
